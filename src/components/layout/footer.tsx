      ...
      <div className="container max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 lg:gap-16 mb-14 md:mb-16 text-center md:text-left">
          ...
          <div className="col-span-1 md:col-span-1 text-center md:text-left">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-4 md:grid-cols-1 md:justify-items-start [&>*:nth-child(even)]:justify-self-end md:[&>*:nth-child(even)]:justify-self-start">
              {navigation.footerQuickLinks.map((link) => (
                <Link key={link.href} href={link.href} className={`text-left text-white/80 text-sm hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-sm block md:mb-4`}>
                  {link.label}
                </Link>
              ))}
            </div>
