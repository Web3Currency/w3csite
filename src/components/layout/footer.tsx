  ...
  return (
    <footer className="border-t border-white/[0.08] bg-black pt-16 md:pt-20 pb-8">
      <div className="container max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 lg:gap-16 mb-14 md:mb-16">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-4">
              {navigation.footerQuickLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-white/80 text-sm hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-sm">
                    {link.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="pt-8 border-t border-white/[0.08] flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/70">
