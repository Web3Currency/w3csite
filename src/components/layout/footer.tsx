        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 lg:gap-16 mb-14 md:mb-16 text-left">
            ...
            <div className="mt-2 md:hidden">
                          <div className="flex flex-row items-center gap-3 flex-nowrap md:flex-col md:items-start md:gap-4">
                            <a href={`tel:${contact.phoneNumber}`} className="group flex items-center gap-3 text-sm text-white/80 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-sm md:flex">
                              ...
                              <span className="hidden md:inline">{contact.phoneNumberFormatted}</span>
                            </a>
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-4 md:block">
              {navigation.footerQuickLinks.filter((link) => link.label !== "FAQ").map((link) => (
                <Link key={link.href} href={link.href} className="text-white/80 text-sm hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-sm md:block md:mb-4">
                  {link.label}
                </Link>
              ))}
            </div>
